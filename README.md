...
## About
This project contains the pre-compiled binaries for use with a specific version of Nginx on CentOS. These configurations are for our use and have not been tested for anything other than our intended purpose.
